...
def usage():
    usage_text = """
Usage: ./get_rain_fall_util.py [-d YYYY-MM-DD] [-t HH:MM:SS] [-h]
...
def get_forecasted_timeseries(tms, model_date_time, forecasted_id0, forecasted_id1,
    ...
    forecast_d0_timeseries = tms.get_timeseries(timeseries_id=forecasted_id0,
                                                start_date=forecast_d0_start.strftime("%Y-%m-%d %H:%M:%S"),
                                                end_date=forecast_d0_end)
    ...
    forecast_d1_timeseries = tms.get_timeseries(timeseries_id=forecasted_id1,
                                                start_date=forecast_d1_start.strftime("%Y-%m-%d %H:%M:%S"),
                                                end_date=forecast_d1_end.strftime("%Y-%m-%d %H:%M:%S"))
    ...
    forecast_d2_timeseries = tms.get_timeseries(timeseries_id=forecasted_id2,
                                                start_date=forecast_d2_start.strftime("%Y-%m-%d %H:%M:%S"),
                                                end_date=forecast_d2_end.strftime("%Y-%m-%d %H:%M:%S"))
...
def get_observed_timeseries(tms, model_date_time, observed_id, backward):
    observed_start = model_date_time - datetime.timedelta(hours=backward*24, minutes=90)
    observed_end = model_date_time
    observed_timeseries = tms.get_timeseries(timeseries_id=observed_id,
                                             start_date=observed_start.strftime("%Y-%m-%d %H:%M:%S"),
                                             end_date=observed_end.strftime("%Y-%m-%d %H:%M:%S"))
    return observed_timeseries


def get_kub_mean_timeseries(tms, model_date_time, observed_id, forecasted_id0, forecasted_id1, forecasted_id2, backward):
    observed_timeseries = get_observed_timeseries(tms, model_date_time, observed_id, backward)
    forecasted_timeseries = get_forecasted_timeseries(tms, model_date_time, forecasted_id0, forecasted_id1,
                                                      forecasted_id2)
...
def get_klb_mean_timeseries(tms, model_date_time, forecasted_id0, forecasted_id1, forecasted_id2, backward):
    forecasted_timeseries = get_forecasted_timeseries(tms, model_date_time, forecasted_id0, forecasted_id1,
                                                      forecasted_id2)
...
def generate_rf_file(db, rf_fall_dir, data_date, data_time, backward=2, forward=3):
    try:
        tms = Timeseries(db)
        ...
        kub_time_series = get_kub_mean_timeseries(tms, model_date_time, kub_observed_id, kub_forecasted_id0,
                                                  kub_forecasted_id1, kub_forecasted_id2, backward)
        kub_rows, kub_columns = kub_time_series.shape
        klb_time_series = get_klb_mean_timeseries(tms, model_date_time, klb_forecasted_id0, klb_forecasted_id1,
